...
namespace reWZ
{
    ...
    public abstract class WZObject
    {
        ...
        public WZObjectType ObjectType { get { return _type; } }
        public WZObject Parent { get { return _parent; } }
        public string Path { get { return _path; } }

        public WZObject this[String childName] { get { throw new NotSupportedException("This WZObject cannot contain children.");}}
    ...
    {
        Directory, Image, Property
    }

    public enum WZPropertyType
    {
        Null, UInt16, Int32, Single, Double, String, Subproperty, Canvas, Vector, Sound, Link
    }
}
